...
public class EightQueenFrame extends JFrame {
	...
	public EightQueenFrame() {
		...
		mnFileStart.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_S, InputEvent.CTRL_MASK));
	...
	private void initBoard() {
		theBoard = new ChessBoard(BOARDSIZE);
		theBoard.addObserver(thePanel);
	}
